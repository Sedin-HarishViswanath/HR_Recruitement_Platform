      ...
      <div className="px-5 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[9px] text-slate-400 mt-0.5 uppercase tracking-[0.12em] font-semibold leading-none">Platform Admin</p>
          </div>
        </div>
      ...
      <div className="p-3 mt-auto border-t border-slate-100">
        <div className="flex items-center gap-2.5 px-3 py-2.5 mb-2 rounded-lg bg-slate-50">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-semibold text-slate-800 truncate leading-tight">{user?.name || 'Super Admin'}</p>
            <p className="text-[9px] text-slate-400 uppercase font-semibold tracking-wider leading-tight">Super Admin</p>
          </div>
        </div>
