      ...
      <div className="px-5 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[9px] text-amber-500/70 mt-0.5 uppercase tracking-[0.15em] font-semibold leading-none">Candidate</p>
          </div>
        </div>
      ...
      <div className="p-3 mt-auto border-t border-white/[0.06]">
        <div className="flex items-center gap-2.5 px-3 py-2.5 mb-2 rounded-xl bg-white/[0.03]">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-semibold text-white truncate leading-tight">{user?.name || 'Candidate'}</p>
            <p className="text-[9px] text-amber-500/60 uppercase font-semibold tracking-wider leading-tight">Candidate</p>
          </div>
        </div>
