    ...
    <div className="min-h-screen bg-[#fafbfc] p-4 sm:p-6 lg:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="card-premium p-3 flex flex-col md:flex-row gap-3">
          ...
          <Button className="h-10 px-6 bg-gradient-to-r from-violet-600 to-violet-700 hover:from-violet-700 hover:to-violet-800 text-white text-[13px] font-bold rounded-xl shadow-sm transition-all btn-premium">
            Search Jobs
          </Button>
        </div>
              ...
              {jobs.map((job) => (
                <div key={job.id} className="card-premium p-4 flex flex-col h-full group hover-lift transition-all">
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500 to-purple-500 text-white flex items-center justify-center font-bold text-lg shrink-0 shadow-sm group-hover:scale-105 transition-transform">
                      {job.company_name?.charAt(0) || 'C'}
                    </div>
                    <div className="min-w-0">
                      <h3 className="font-bold text-[14px] text-slate-900 line-clamp-1 group-hover:text-violet-600 transition-colors leading-tight">
                        {job.title}
                      </h3>
                  ...
                  <div className="mt-auto pt-3 border-t border-slate-50 flex items-center justify-between">
                    ...
                    {job.already_applied ? (
                      ...
                      <ApplyModal 
                        ...
                        trigger={
                          <Button size="sm" className="h-8 px-4 bg-gradient-to-r from-violet-600 to-violet-700 hover:from-violet-700 hover:to-violet-800 text-white text-[11px] font-bold rounded-lg shadow-sm transition-all active:scale-95">
                            View & Apply
                          </Button>
                        }
                      />
                      ...
                      <Button 
                        ...
                        className="h-8 px-4 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 text-[11px] font-bold rounded-lg shadow-sm transition-all active:scale-95">
                        Sign In to Apply
                      </Button>
                    )}
                  </div>
