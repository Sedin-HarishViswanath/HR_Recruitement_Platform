...
export const stageTransitionSchema = z.object({
  stage: z.enum(['applied', 'screening', 'shortlisted', 'interview_1', 'interview_2', 'offer', 'hired', 'rejected']),
  notes: z.string().optional(),
});

export const bulkMoveSchema = z.object({
  application_ids: z.array(z.string()).min(1),
  target_stage: z.enum(['applied', 'screening', 'shortlisted', 'interview_1', 'interview_2', 'offer', 'hired', 'rejected']),
});
...
export const createApplicationSchema = z.object({
  ...
  job_id: z.string(),
  cover_note: z.string().max(500).optional(),
  initial_stage: z.enum(['applied', 'screening', 'shortlisted', 'interview_1', 'interview_2', 'offer', 'hired', 'rejected']).default('applied'),
